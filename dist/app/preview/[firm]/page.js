...
exports.default = PreviewFirmPage;
const navigation_1 = require("next/navigation");
const link_1 = __importDefault(require("next/link"));
const react_1 = require("react");
function PreviewFirmPage() {
    const params = (0, navigation_1.useParams)();
    const firm = decodeURIComponent(params.firm);
        ...
        const timer = setInterval(() => {
            ...
            setTasks(prevTasks => prevTasks.map(task => {
                if (task.status === 'processing' && task.progress < 100) {
                    ...
                    return Object.assign(Object.assign({}, task), { progress: newProgress, status: newProgress === 100 ? 'completed' : 'processing' });
                }
                if (task.status === 'pending' && Math.random() < 0.1) {
                    return Object.assign(Object.assign({}, task), { status: 'processing', progress: 5 });
                }
                return task;
            }));
        }, 1000);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gray-800/30 backdrop-blur-md rounded-lg p-6 mb-8">
          ...
          <div className="space-y-4">
            {tasks.map((task) => (<div key={task.id} className="border border-gray-700 rounded-lg p-4">
                ...
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div className="bg-gradient-to-r from-blue-500 to-green-500 h-2 rounded-full transition-all duration-500" style={{ width: `${task.progress}%` }}></div>
                </div>
        ...
        <div className="flex justify-center">
          <link_1.default href="/" className="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg font-semibold transition-colors duration-200">
