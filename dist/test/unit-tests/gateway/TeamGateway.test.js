...
const TeamGateway = require('../../../services/gateway/TeamGateway');
...
describe('TeamGateway', () => {
  ...
  beforeEach(() => {
    ...
    teamServiceMock = {
      getTeamDetails: sinon.stub().resolves({ id: 'test-team-id', status: 'active' })
    };
  ...
  it('should require teamService dependency', () => {
    expect(() => new TeamGateway({
      logger: loggerMock,
      sallyPortVerifier: mockSallyPortVerifier
    })).to.throw('teamService is required for TeamGateway');
  });
