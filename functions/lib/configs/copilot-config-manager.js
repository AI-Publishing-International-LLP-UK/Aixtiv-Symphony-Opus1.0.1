...
class CoPilotConfigManager extends events_1.EventEmitter {
    ...
    findConfigsByTags(tags) {
        return Array.from(this.configs.values()).filter(config => tags.every(tag => { var _a; return (_a = config.tags) === null || _a === void 0 ? void 0 : _a.includes(tag); }));
    }
    /**
     * Create a new configuration entry
     */
    async createConfig(type, name, data, options = {}) {
...
//# sourceMappingURL=copilot-config-manager.js.map