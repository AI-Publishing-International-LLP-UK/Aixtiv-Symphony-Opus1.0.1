...
class ModelSelector {
    ...
    async registerServiceModels(serviceId, models) {
        try {
            ...
            for (const model of models) {
                ...
                // Store in Firestore
                await db.collection('modelCatalog').doc(modelId).set(Object.assign(Object.assign({}, model), { serviceId, fullModelId: modelId, updatedAt: admin.firestore.FieldValue.serverTimestamp() }));
            }
    ...
    async updateUserPreferences(userId, preferences) {
        try {
            ...
            // Update in Firestore
            await db.collection('userModelPreferences').doc(userId).set(Object.assign(Object.assign({}, preferences), { updatedAt: admin.firestore.FieldValue.serverTimestamp() }));
...
class PollingBinding extends BaseBinding {
    ...
    async poll() {
        try {
            ...
            // Execute operation
            const result = await this.gateway.execute(this.serviceId, this.pollOperation, this.pollParams);
            // Process result
       ...
       */
            ...
            class IntegrationGateway {
                ...
                async registerService(serviceConfig) {
                    try {
                        ...
                        await this.rustGateway.registerService(serviceId, Object.assign(Object.assign({}, serviceConfig), { credentials: authStrategy.getMaskedCredentials() }));
                        ...
                        if (!docSnapshot.exists) {
                            await serviceDoc.set(Object.assign(Object.assign({}, serviceConfig), { status: 'active', registeredAt: admin.firestore.FieldValue.serverTimestamp(), lastConnected: admin.firestore.FieldValue.serverTimestamp() }));
                        }
                        else {
                    ...
                    try {
                        ...
                        if (((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === 401 && connection.credentials.refreshToken) {
                            try {
                                ...
                                // Retry the operation
                                const result = await adapter[operation](params, Object.assign(Object.assign({}, connection), { credentials: newCredentials }));
                                // Update statistics
                                connection.statistics.successfulRequests++;
                                const duration = Date.now() - startTime;
                                connection.statistics.avgResponseTime =
            ...
            class OAuth2AuthStrategy {
                ...
                async _storeTokens(tokens) {
                    try {
                        // Store in Firestore
                        await db.collection('serviceTokens').doc(this.config.serviceId).set(Object.assign(Object.assign({}, tokens), { updatedAt: admin.firestore.FieldValue.serverTimestamp() }));
                        return true;
                    }
                    catch (error) {
