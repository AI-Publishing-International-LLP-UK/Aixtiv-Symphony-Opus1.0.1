...
class S2DOVerifier {
     ...
     */
    verifySignature(stem_1, action_1, payload_1, signature_1) {
        return __awaiter(this, arguments, void 0, function* (stem, action, payload, signature, keyId = 'default') {
     ...
     */
    performVerification(stem, action, payload, signature, keyId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (typeof window !== 'undefined' && window.crypto && window.crypto.subtle) {
                    const result = yield window.crypto.subtle.verify({
                        name: 'ECDSA',
                        hash: { name: 'SHA-256' }
...
class SecuritySelfHealer {
    ...
    registerDefaultHealingActions() {
        ...
        this.registerHealingAction('auth_rate_limit_exceeded', () => __awaiter(this, void 0, void 0, function* () {
            // Reset authentication rate limits
            return true;
        }));
        this.registerHealingAction('auth_failure_spike', () => __awaiter(this, void 0, void 0, function* () {
            // Temporarily increase logging for auth attempts
            return true;
        }));
        // S2DO verification issues
        this.registerHealingAction('s2do_verification_failure', () => __awaiter(this, void 0, void 0, function* () {
            // Refresh S2DO verification keys
            return true;
        }));
        // Session issues
        this.registerHealingAction('session_hijacking_detected', () => __awaiter(this, void 0, void 0, function* () {
            // Force session refresh for affected users
            return true;
        }));
        // Integration issues
        this.registerHealingAction('integration_connection_failure', () => __awaiter(this, void 0, void 0, function* () {
            // Attempt to reconnect integration
            return true;
        }));
        // Agent issues
        this.registerHealingAction('agent_activation_failure', () => __awaiter(this, void 0, void 0, function* () {
            // Reset agent state
            return true;
        }));
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authFailures.length > 20) { // If more than 20 recent auth failures
                    yield this.healSecurityIssue('auth_failure_spike');
                }
                ...
                if (s2doFailures.length > 5) { // If more than 5 recent S2DO verification failures
                    yield this.healSecurityIssue('s2do_verification_failure');
                }
                ...
                if (integrationFailures.length > 5) { // If more than 5 recent integration failures
                    yield this.healSecurityIssue('integration_connection_failure');
                }
                ...
                if (agentFailures.length > 10) { // If more than 10 recent agent failures
                    yield this.healSecurityIssue('agent_activation_failure');
                }
                ...
                if (possibleHijackings.length > 0) {
                    yield this.healSecurityIssue('session_hijacking_detected');
                }
            }
            catch (error) {
