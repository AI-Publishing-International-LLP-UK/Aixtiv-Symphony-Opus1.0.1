...
class DrMatchLinkedInService {
     ...
     */
    executeApiCall(apiCall_1, endpoint_1, method_1) {
        return __awaiter(this, arguments, void 0, function* (apiCall, endpoint, method, requiredUnits = 1) {
     ...
     */
    searchAdLibrary(criteria) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.executeApiCall(() => __awaiter(this, void 0, void 0, function* () {
                if (!this.accessToken) {
                    throw new Error('Not authenticated');
                }
                const response = yield axios_1.default.get('https://api.linkedin.com/rest/adLibrary', {
...
function demonstrateDrMatchLinkedInCapabilities() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const adLibraryResults = yield linkedInService.searchAdLibrary({
...
class DrMatchLinkedInService {
    ...
    authenticate() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.post('https://www.linkedin.com/oauth/v2/accessToken', {
     ...
     */
    initializeContentUpload(contentType) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.accessToken) {
                throw new Error('Not authenticated');
            }
            try {
                ...
                const response = yield axios_1.default.post(`https://api.linkedin.com${endpoint}`, {}, {
                    headers: {
                        'Authorization': `Bearer ${this.accessToken}`,
    ...
    shareContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios_1.default.post('https://api.linkedin.com/rest/posts', {
                    content: {
                        title: content.title,
...
function demonstrateDrMatchLinkedInCapabilities() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log('Ad Library Search Results:', adLibraryResults);
            // Initialize Content Upload
            const uploadInitiation = yield linkedInService.initializeContentUpload('image');
            console.log('Content Upload Initiated:', uploadInitiation);
            // Share Content
            const contentShare = yield linkedInService.shareContent({
            ...
            const userInfo = yield linkedInService.getUserInfo();
...
class DrMatchLinkedInService {
    ...
    createEvent(eventDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios_1.default.post('https://api.linkedin.com/rest/events', {
     ...
     */
    getEventAttendees(eventUrn) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.accessToken) {
                throw new Error('Not authenticated');
            }
            try {
                const response = yield axios_1.default.get('https://api.linkedin.com/rest/eventRoleAssignments', {
                    params: {
                        eventUrn: eventUrn
                    },
                    headers: {
     ...
     */
    createLiveVideo(videoDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.accessToken) {
                throw new Error('Not authenticated');
            }
            try {
                const response = yield axios_1.default.post('https://api.linkedin.com/rest/liveVideos', {
     ...
     */
    getLiveVideoViewerAnalytics(videoUrn) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.accessToken) {
                throw new Error('Not authenticated');
            }
            try {
                const response = yield axios_1.default.get('https://api.linkedin.com/rest/liveViewerCountAnalytics', {
                    params: {
                        videoUrn: videoUrn
                    },
                    headers: {
     ...
     */
    getOrganizationDomainMapping() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.accessToken) {
                throw new Error('Not authenticated');
            }
            try {
                const response = yield axios_1.default.get('https://api.linkedin.com/rest/organizationEmailDomainMapping', {
                    headers: {
                        'Authorization': `Bearer ${this.accessToken}`,
                        'LinkedIn-Version': '202405'
                    }
     ...
     */
    getBusinessManagerAccounts() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.accessToken) {
                throw new Error('Not authenticated');
            }
            try {
                const response = yield axios_1.default.get('https://api.linkedin.com/rest/businessManagerAccounts', {
                    headers: {
                        'Authorization': `Bearer ${this.accessToken}`,
                        'LinkedIn-Version': '202405'
                    }
...
function demonstrateDrMatchLinkedInCapabilities() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const eventUrn = yield linkedInService.createEvent({
            ...
            const attendees = yield linkedInService.getEventAttendees(eventUrn);
            console.log('Event Attendees:', attendees);
            // Create a Live Video
            const liveVideo = yield linkedInService.createLiveVideo({
            ...
            const videoAnalytics = yield linkedInService.getLiveVideoViewerAnalytics(liveVideo.videoUrn);
            console.log('Live Video Analytics:', videoAnalytics);
            // Retrieve Business Manager Accounts
            const businessAccounts = yield linkedInService.getBusinessManagerAccounts();
