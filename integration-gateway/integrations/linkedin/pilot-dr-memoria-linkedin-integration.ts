...
export class LinkedInContentSeriesService {
  ...
  async createContentSeries(
    ...
    try {
      const response = await axios.post('https://api.linkedin.com/rest/contentSeries', 
        {
  ...
  async publishContent(
    ...
    try {
      const response = await axios.post('https://api.linkedin.com/rest/originalArticles', 
        {
  ...
  async getContentAnalytics(
    ...
    try {
      const response = await axios.get('https://api.linkedin.com/rest/contentAnalytics', {
        params: {
   ...
   */
  async getSeriesSubscriberDemographics(
    seriesUrn: string
  ): Promise<{
    ...
    try {
      const response = await axios.get('https://api.linkedin.com/rest/seriesSubscribers', {
        params: {
          series: seriesUrn,
          demographics: true
        },
...
async function demonstrateContentPublishingWorkflow() {
  const linkedInService = new LinkedInContentSeriesService(DrMemoriaLinkedInConfig);
  ...
  try {
    ...
    const subscriberDemographics = await linkedInService.getSeriesSubscriberDemographics(
      seriesUrn
    );
