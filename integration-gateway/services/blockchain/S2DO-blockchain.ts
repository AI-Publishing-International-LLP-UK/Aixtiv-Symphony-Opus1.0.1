 ...
 */
export class SD20BlockchainService implements BlockchainService {
  ...
  constructor(
    rpcUrl: string,
    privateKey: string,
    actionVerificationContractAddress: string,
    actionVerificationContractAbi: any[],
   ...
   */
  private calculateRoyaltyShares(contributorCount: number): number[] {
 ...
 */
export const SD20ActionVerificationContract = `
