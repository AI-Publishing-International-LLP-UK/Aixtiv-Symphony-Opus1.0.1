  ...
  (exports.modules = {
    ...
    2410: (e, t, r) => {
      ...
      class v {
        ...
        getRootSpanAttributes() {
          const e = i.active().getValue(h);
          return _.get(e);
        }
        setRootSpanAttribute(e, t) {
          const r = i.active().getValue(h),
            n = _.get(r);
          n && n.set(e, t);
        }
      }
    ...
    3135: (e, t) => {
      ...
      function o(e, t) {
        ...
        const i = Math.min(Math.floor(Math.log10(e) / 3), r.length - 1);
        ...
        var t = {
                ...
                constructor() {
                  ...
                  ((t.setLogger = (e, r = { logLevel: a.DiagLogLevel.INFO }) => {
                    ...
                    if (u && !r.suppressOverrideMessage) {
                      const e = null != (l = Error().stack) ? l : '<failed to generate stacktrace>';
            ...
            172: (e, t, r) => {
              ...
              ((t.registerGlobal = function (e, t, r, n = !1) {
                var a;
                const i = (l[s] = null != (a = l[s]) ? a : { version: o.VERSION });
                if (!n && i[e]) {
                  const t = Error(
                ...
                (t.getGlobal = function (e) {
                  var t, r;
                  const n = null == (t = l[s]) ? void 0 : t.version;
            ...
            614: (e, t, r) => {
              ...
              class l {
                startSpan(e, t, r = s.active()) {
                  ...
                  const l = r && (0, o.getSpanContext)(r);
    ...
    8548: (e, t, r) => {
      ...
      const g = new Set();
      function _(e, t, r) {
        const n = (0, i.getPageFiles)(e, '/_app'),
      ...
      function v(e, t) {
        let { scriptLoader: r, disableOptimizedLoading: a, crossOrigin: i } = e,
          s = (function (e, t) {
            const { assetPrefix: r, scriptLoader: a, crossOrigin: i, nextScriptWorkers: s } = e;
            if (!s) return null;
            try {
              const { partytownSnippet: e } = require('@builder.io/partytown/integration'),
      ...
      class b extends o.default.Component {
        ...
        render() {
          ...
          const M = _(this.context.buildManifest, this.context.__NEXT_DATA__.page, a),
            C = (function (e, t, r = '') {
              if (!e) return { preconnect: null, preload: null };
              const o = e.pages['/_app'],
                a = e.pages[t],
          ...
          return (0, n.jsxs)('head', {
            ...(function (e) {
              const { crossOrigin: t, nonce: r, ...n } = e;
              return n;
            })(this.props),
            children: [
      ...
      class O extends o.default.Component {
        ...
        static getInlineScriptSource(e) {
          const { __NEXT_DATA__: t, largePageDataBytes: n } = e;
          try {
            const o = JSON.stringify(t);
            if (g.has(t.page)) return (0, s.htmlEscapeJsonString)(o);
            const a = Buffer.from(o).byteLength,
              i = r(3135).A;
            return (
              n &&
                a > n &&
...
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
        ...
        render() {
          ...
          const d = _(this.context.buildManifest, this.context.__NEXT_DATA__.page, t);
          return (0, n.jsxs)(n.Fragment, {
            children: [
              !u && r.devFiles
                ? r.devFiles.map((t) =>
    ...
    8893: (e, t, r) => {
      ...
      const n = r(7113),
        o = r(8318);
      function a(e, t) {
        const r = (0, n.denormalizePagePath)((0, o.normalizePagePath)(t)),
          a = e.pages[r];
        return (
