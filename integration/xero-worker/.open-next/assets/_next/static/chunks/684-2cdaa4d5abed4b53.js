  ...
  [684],
  {
                  ...
                  const [u, l, a, i, c] = t,
                    s =
                      'string' == typeof (r = u) && r.startsWith(n.PAGE_SEGMENT_KEY + '?')
                        ...
                        : r,
                    f = {};
                  for (const [t, r] of Object.entries(l)) f[t] = e(r);
                  const d = [s, f, null, (o = i) && 'refresh' !== o ? i : null];
        ...
        !(function (e, t) {
          ...
          navigateReducer: function () {
            return function e(t, r) {
              ...
              const C = (0, _.getOrCreatePrefetchCacheEntry)({
                  url: E,
                  nextUrl: t.nextUrl,
                  tree: t.tree,
                  prefetchCache: t.prefetchCache,
                ...
                A.then(
                  (d) => {
                    ...
                    if ((C.lastUsedTime || ((C.lastUsedTime = j), (A = !0)), C.aliased)) {
                      const n = (0, g.handleAliasedPrefetchEntry)(j, t, _, E, T);
                      return !1 === n ? e(t, { ...r, allowAliasing: !1 }) : n;
                    }
                    if ('string' == typeof _) return v(t, T, _, w);
                    const N = O ? (0, o.createHrefFromUrl)(O) : M;
                    ...
                    for (const e of _) {
                      ...
                      if (
                        ...
                        if (o && _ && R) {
                          const e = (0, y.startPPRNavigation)(j, U, D, g, o, s, d, !1, L);
                          if (null !== e) {
                            ...
                            if (null !== o) {
                              const r = (0, n.fetchServerResponse)(E, {
                                flightRouterState: o,
                                nextUrl: t.nextUrl,
                              });
                          ...
                          let n = (0, p.createEmptyCacheNode)(),
                            o = !1;
                          for (const t of (C.status !== c.PrefetchCacheEntryStatus.stale || A
        ...
        return b.lazyData.then(
          async (r) => {
            ...
            for (const r of ((b.lazyData = null), n)) {
              ...
              const E = (0, u.applyRouterStatePatchToTree)([''], _, n, e.canonicalUrl);
              ...
              const O = s ? (0, o.createHrefFromUrl)(s) : void 0;
      ...
      function s(e, t, r, s, d) {
        ...
        for (const t of r) {
          ...
          let { seedData: l, isRootRender: c, pathToSegment: d } = t,
            b = ['', ...d];
          r = f(r, Object.fromEntries(s.searchParams));
          const g = (0, u.applyRouterStatePatchToTree)(b, h, r, _),
    ...
    8586: (e, t, r) => {
      ...
      async function h(e, t) {
        let { flightRouterState: r, nextUrl: o, prefetchKind: u } = t,
          c = {
            [n.RSC_HEADER]: '1',
            [n.NEXT_ROUTER_STATE_TREE_HEADER]: (0, a.prepareFlightRouterStateForRequest)(
              r,
              t.isHmrRefresh
            ),
          };
    ...
    8709: (e, t, r) => {
      ...
      async function M(e, t, r) {
        ...
        const E = !!y.headers.get(u.NEXT_IS_PRERENDER_HEADER);
        try {
