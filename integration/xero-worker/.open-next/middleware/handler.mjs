...
globalThis.openNextVersion = '3.7.4';
...
var NextConfig = {
  ...
  outputFileTracingRoot: '/Users/as/asoos/integration/xero-worker',
  experimental: {
  ...
  turbopack: { root: '/Users/as/asoos/integration/xero-worker' },
};
var BuildId = 'anb_zu9Nv6VHogYN6Esa_';
var RoutesManifest = {
  basePath: '',
...
var PrerenderManifest = {
  ...
  notFoundRoutes: [],
  preview: {
    previewModeId: 'caa983facd6f04948da6b9108f45dda8',
    previewModeSigningKey: '17e2fed2941d52f6138e2474595e6d457050a43315efeedb15d693a142319370',
    previewModeEncryptionKey: '7091f02b5693f6f1aed61377436753a134355aaf4ef04d0354cd579868d1874b',
  },
};
  ...
  return function (pathname) {
    ...
    var _loop_1 = function (i2) {
      ...
      if (key.modifier === '*' || key.modifier === '+') {
        params[key.name] = m[i2].split(key.prefix + key.suffix).map((value) => {
