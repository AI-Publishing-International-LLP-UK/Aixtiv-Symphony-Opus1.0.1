  ...
  ((A.id = 230),
    ...
    (A.modules = {
      ...
      1243: (A, e) => {
        ...
        const w = 'undefined' == typeof URLPattern ? void 0 : URLPattern;
      },
      2079: (A, e, w) => {
        'use strict';
        (Object.defineProperty(e, '__esModule', { value: !0 }),
        ...
        const i = w(1617),
          ...
          P = new WeakMap();
        async function a() {
          const A = t.workAsyncStorage.getStore();
          if (!A)
                ...
                if (i) {
                  ...
                  if (u) {
                    if ('prerender' === w.type) {
                      const e = P.get(A);
                      if (e) return e;
                      const i = (0, n.makeHangingPromise)(w.renderSignal, '`unstable_rootParams`');
                      return (P.set(A, i), i);
                    }
                    var t = A,
                      o = i,
                        ...
                        D.wellKnownProperties.has(A) ||
                          (o.has(A)
                            ? Object.defineProperty(c, A, {
                                get() {
                                  const e = (0, D.describeStringPropertyAccess)(
                                    'unstable_rootParams',
                                    A
                                  );
      ...
      3426: (A, e, w) => {
        ...
        function a(A, e) {
          ...
          if (null == A || null == (w = A.request) ? void 0 : w.headers) {
            ...
            const w = [];
            for (const [i, r] of A.request.headers)
        ...
        class s extends Response {
          ...
          static json(A, e) {
            const w = Response.json(A, e);
            return new s(w.body, w);
          }
          static redirect(A, e) {
            const w = 'number' == typeof e ? e : ((null == e ? void 0 : e.status) ?? 307);
            if (!P.has(w))
              throw Object.defineProperty(
          ...
          static rewrite(A, e) {
            const w = new Headers(null == e ? void 0 : e.headers);
            return (
          ...
          static next(A) {
            const e = new Headers(null == A ? void 0 : A.headers);
      ...
      6136: (A, e, w) => {
        ...
        const a = 'force-static',
          s = new r.AppRouteRouteModule({
            ...
            resolvedPagePath:
              'next-metadata-route-loader?filePath=%2FUsers%2Fas%2Fasoos%2Fintegration%2Fxero-worker%2Fsrc%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__',
