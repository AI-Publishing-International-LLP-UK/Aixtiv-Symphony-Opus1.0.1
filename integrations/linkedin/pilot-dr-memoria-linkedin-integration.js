...
class LinkedInOAuthService {
    ...
    inspectAccessToken(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.post('https://www.linkedin.com/oauth/v2/introspect', new URLSearchParams({
                    token: accessToken,
                    client_id: this.config.clientId,
                    client_secret: this.config.clientSecret
                }), {
...
function demonstrateLinkedInOAuthFlow() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const tokenResponse = yield oauthService.exchangeCodeForToken('SIMULATED_AUTH_CODE');
            console.log('Access Token:', tokenResponse.access_token);
            // Inspect the token
            const tokenInspection = yield oauthService.inspectAccessToken(tokenResponse.access_token);
...
class LinkedInContentSeriesService {
    ...
    createContentSeries(seriesDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios_1.default.post('https://api.linkedin.com/rest/contentSeries', {
    ...
    publishContent(workflow) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios_1.default.post('https://api.linkedin.com/rest/originalArticles', {
    ...
    getContentAnalytics(contentUrn) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios_1.default.get('https://api.linkedin.com/rest/contentAnalytics', {
                    params: {
    ...
    getSeriesSubscriberDemographics(seriesUrn) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios_1.default.get('https://api.linkedin.com/rest/seriesSubscribers', {
                    params: {
                        series: seriesUrn,
                        demographics: true
                    },
...
function demonstrateContentPublishingWorkflow() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const contentAnalytics = yield linkedInService.getContentAnalytics(publishedContent.postUrn);
            // Get subscriber demographics
            const subscriberDemographics = yield linkedInService.getSeriesSubscriberDemographics(seriesUrn);
