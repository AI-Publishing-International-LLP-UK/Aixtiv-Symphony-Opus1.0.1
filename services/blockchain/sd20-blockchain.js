    ...
    storeActionVerification(actionId, actionHash, initiatorAddress, verifierAddresses) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const tx = yield this.actionVerificationContract.recordVerification(actionId, actionHash, initiatorAddress, verifierAddresses, { gasLimit: 500000 });
    ...
    mintNFT(metadata, ownerAddress, contributorAddresses) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const metadataUri = yield this.storeMetadataOnIPFS(metadata);
                ...
                const tx = yield this.nftContract.mintActionNFT(ownerAddress, metadataUri, contributorAddresses, shares, { gasLimit: 700000 });
                // Wait for transaction to be mined
                const receipt = yield tx.wait();
    ...
    verifyActionRecord(actionId, actionHash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const storedHash = yield this.actionVerificationContract.getActionHash(actionId);
