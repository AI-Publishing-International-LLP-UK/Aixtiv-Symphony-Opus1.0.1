    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 to-blue-600 flex flex-col items-center justify-center p-8">
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 mb-8">
          ...
          {selectedFirm && (
            <Link
              href={`/preview/${encodeURIComponent(selectedFirm)}`}
              className="inline-block bg-yellow-400 text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition-colors duration-200"
            >
