...
(function (PilotType) {
    ...
    PilotType["DR_BURBY_PILOT"] = "DBP"; // CFO/GC, Risk Management
 ...
 */
function addUserWithBlockchainVerification(userData) {
    return __awaiter(this, void 0, void 0, function* () {
        // Implementation would interact with Firebase/Firestore and blockchain
        // This is a placeholder for the actual implementation
        // Generate blockchain verification
        const blockchainVerification = yield generateBlockchainVerification(userData);
 ...
 */
function generateBlockchainVerification(userData) {
    return __awaiter(this, void 0, void 0, function* () {
